  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div
        key={index}
        className="bg-cream-50 p-6 rounded-xl card-hover border border-cream-200 text-center"
        >
      ...
      {/* Key Message */}
      <div className="bg-gradient-to-r from-warm-600 to-warm-500 p-8 rounded-2xl text-white text-center">
